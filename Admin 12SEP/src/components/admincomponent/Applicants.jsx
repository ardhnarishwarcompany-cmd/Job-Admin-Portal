    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-20">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-cyan-600 to-sky-700 p-7 text-white shadow-2xl shadow-blue-200 mb-7"
        >
          <motion.div
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-2xl font-black">Manage Applicants</h1>
