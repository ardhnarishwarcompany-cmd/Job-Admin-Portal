...
import Atish from './1.png';
import Atish1 from './1.png';
import Atish2 from './1.png';

const Creator = () => {
  return (
    <div>
      <Navbar />
      <div className="flex flex-col items-center justify-center min-h-screen max-w-7xl mx-auto p-4 sm:p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center w-full">
          {/* Image Section */}
          <div className="flex justify-center">
            <img src={amreshsir} alt="Amresh Sir" className="h-64 w-full max-w-sm object-cover rounded-lg shadow-md sm:h-80" />
          </div>
          {/* Text Section */}
          <div>
      ...
      <div className="text-center p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <a href="https://ankitpathak.vercel.app/" target="_blank" rel="noopener noreferrer" className="block text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-700 mt-2">Sanchit Dhiman</h3>
          ...
          <a href="#" className="block text-center">
            ...
            <p className="text-gray-600 text-sm">Node.js Developer</p>
          </a>
